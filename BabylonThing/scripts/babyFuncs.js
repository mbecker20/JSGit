class BF {
    ...
    static MakeBox(name, params, scene) {
        // params: length, width, height,...
        return BABYLON.MeshBuilder.CreateBox(name, params, scene);
    }

    static MakeSphere(name, params, scene) {
        // params: diameter, segments
        return BABYLON.MeshBuilder.CreateSphere(name, params, scene);
    }
    ...
    static MakeCylinder(name, params, scene) {
        // params: height, diameter, tessellation
        return BABYLON.MeshBuilder.CreateCylinder(name, params, scene);
    }
    ...
    static MakeTube(name, scene, direction, diameter) {
        //name is string
        //pointing [1,0,0];
        //tail at origin;
        //direction is ar3
