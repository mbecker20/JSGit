...
export class BF {
    ...
    // sound constructor
    static MakeSound(name, path, scene, onLoadFn = null) {
        return new BABYLON.Sound(name, path, scene, onLoadFn);
    }
...
export class MySounds {
    ...
    constructor(scene) {
        ...
        this.blockHit = BF.MakeSound('blockHit', './resources/blockHit.mp3', scene);
